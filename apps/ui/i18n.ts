import ENTranslation from '@repo/translations/locales/en.json';
import FRTranslation from '@repo/translations/locales/fr.json';
...
i18n.on('languageChange', (language: string) => {
  const lng = LocaleZodType.parse(language);
